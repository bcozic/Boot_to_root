cmd_scripts/mod/modpost.o := gcc -Wp,-MD,scripts/mod/.modpost.o.d -Iscripts/mod -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer -c -o scripts/mod/modpost.o /build/linux-wZY2wj/linux-3.2.0/scripts/mod/modpost.c

source_scripts/mod/modpost.o := /build/linux-wZY2wj/linux-3.2.0/scripts/mod/modpost.c
...
deps_scripts/mod/modpost.o := \
  ...
  /build/linux-wZY2wj/linux-3.2.0/scripts/mod/../../include/linux/license.h \
