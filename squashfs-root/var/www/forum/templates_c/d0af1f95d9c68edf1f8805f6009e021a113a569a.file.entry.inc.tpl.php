<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-10-07 23:57:07
         compiled from "themes/default/subtemplates/entry.inc.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10886491175615b153aa0af4-21654520%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd0af1f95d9c68edf1f8805f6009e021a113a569a' => 
    array (
  ...
  'nocache_hash' => '10886491175615b153aa0af4-21654520',
  'function' => 
  array (
    'tree' => 
    array (
  ...
  'unifunc' => 'content_5615b153cc2bd6_16748444',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5615b153cc2bd6_16748444')) {function content_5615b153cc2bd6_16748444($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/var/www/forum/modules/smarty/plugins/modifier.replace.php';
...
<?php }?>
<?php if ($_smarty_tpl->tpl_vars['posting_user_id']->value>0&&($_smarty_tpl->tpl_vars['user']->value||$_smarty_tpl->tpl_vars['settings']->value['user_area_public']==1)) {
$_smarty_tpl->tpl_vars['name'] = new Smarty_variable("<a href=\"index.php?mode=user&amp;show_user=".((string)$_smarty_tpl->tpl_vars['posting_user_id']->value)."\">".((string)$_smarty_tpl->tpl_vars['name']->value)."</a>", null, 0);
}?>
...
echo smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace($_smarty_tpl->getConfigVariable('posted_by_location'),"[name]",$_smarty_tpl->tpl_vars['name']->value),"[email_hp]",$_smarty_tpl->tpl_vars['email_hp']->value),"[location]",$_smarty_tpl->tpl_vars['location']->value),"[time]",$_smarty_tpl->tpl_vars['formated_time']->value);
} else {
echo smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace($_smarty_tpl->getConfigVariable('posted_by'),"[name]",$_smarty_tpl->tpl_vars['name']->value),"[email_hp]",$_smarty_tpl->tpl_vars['email_hp']->value),"[time]",$_smarty_tpl->tpl_vars['formated_time']->value);
}?> <span class="ago">(<?php if ($_smarty_tpl->tpl_vars['ago']->value['days']>1) {
echo smarty_modifier_replace($_smarty_tpl->getConfigVariable('posting_several_days_ago'),"[days]",$_smarty_tpl->tpl_vars['ago']->value['days_rounded']);
} else {
if ($_smarty_tpl->tpl_vars['ago']->value['days']==0&&$_smarty_tpl->tpl_vars['ago']->value['hours']==0) {
echo smarty_modifier_replace($_smarty_tpl->getConfigVariable('posting_minutes_ago'),"[minutes]",$_smarty_tpl->tpl_vars['ago']->value['minutes']);
} elseif ($_smarty_tpl->tpl_vars['ago']->value['days']==0&&$_smarty_tpl->tpl_vars['ago']->value['hours']!=0) {
echo smarty_modifier_replace(smarty_modifier_replace($_smarty_tpl->getConfigVariable('posting_hours_ago'),"[hours]",$_smarty_tpl->tpl_vars['ago']->value['hours']),"[minutes]",$_smarty_tpl->tpl_vars['ago']->value['minutes']);
} else {
echo smarty_modifier_replace(smarty_modifier_replace($_smarty_tpl->getConfigVariable('posting_one_day_ago'),"[hours]",$_smarty_tpl->tpl_vars['ago']->value['hours']),"[minutes]",$_smarty_tpl->tpl_vars['ago']->value['minutes']);
}
...
echo $_smarty_tpl->getConfigVariable('one_view');
} else {
echo smarty_modifier_replace($_smarty_tpl->getConfigVariable('several_views'),"[views]",$_smarty_tpl->tpl_vars['views']->value);
}?></span><?php } else { ?>&nbsp;<?php }?>
...
echo $_smarty_tpl->getConfigVariable('lock_linktitle');
} else {
echo $_smarty_tpl->getConfigVariable('unlock_linktitle');
}?>"><?php if ($_smarty_tpl->tpl_vars['locked']->value==0) {
echo $_smarty_tpl->getConfigVariable('lock_linkname');
} else {
echo $_smarty_tpl->getConfigVariable('unlock_linkname');
}?></a></li>
...
if ($_smarty_tpl->tpl_vars['read']->value&&in_array($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['element']->value]['id'],$_smarty_tpl->tpl_vars['read']->value)) {?> read<?php }?>" href="index.php?id=<?php echo $_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['element']->value]['id'];?>
...
smarty_template_function_tree($_smarty_tpl,array('element'=>$_smarty_tpl->tpl_vars['child']->value,'level'=>$_smarty_tpl->tpl_vars['level']->value+1));
} ?></ul><?php }?></li>
