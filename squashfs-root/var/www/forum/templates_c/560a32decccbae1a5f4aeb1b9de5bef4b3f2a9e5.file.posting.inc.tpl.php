<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-10-07 23:55:47
         compiled from "themes/default/subtemplates/posting.inc.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11504547655615b103497a17-49585252%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '560a32decccbae1a5f4aeb1b9de5bef4b3f2a9e5' => 
    array (
  ...
  'nocache_hash' => '11504547655615b103497a17-49585252',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5615b1036f3fd3_83225053',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5615b1036f3fd3_83225053')) {function content_5615b1036f3fd3_83225053($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/var/www/forum/modules/smarty/plugins/modifier.replace.php';
...
$_config = new Smarty_Internal_Config($_smarty_tpl->tpl_vars['language_file']->value, $_smarty_tpl->smarty, $_smarty_tpl);$_config->loadConfigVars("captcha", 'local');
}?>
...
echo $_smarty_tpl->getConfigVariable('new_topic_hl');
} elseif ($_smarty_tpl->tpl_vars['posting_mode']->value==0&&$_smarty_tpl->tpl_vars['id']->value>0) {
echo $_smarty_tpl->getConfigVariable('reply_hl');
} elseif ($_smarty_tpl->tpl_vars['posting_mode']->value==1) {
echo $_smarty_tpl->getConfigVariable('edit_hl');
}?></h1>
...
echo smarty_modifier_replace($_smarty_tpl->getConfigVariable('minutes_left_to_edit_reply'),"[minutes]",$_smarty_tpl->tpl_vars['minutes_left_to_edit']->value);
} else {
echo smarty_modifier_replace($_smarty_tpl->getConfigVariable('minutes_left_to_edit'),"[minutes]",$_smarty_tpl->tpl_vars['minutes_left_to_edit']->value);
}?></p>
<?php }?>
...
echo smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace($_smarty_tpl->getConfigVariable('posted_by_location'),"[name]",$_smarty_tpl->tpl_vars['preview_name']->value),"[email_hp]",$_smarty_tpl->tpl_vars['email_hp']->value),"[location]",$_smarty_tpl->tpl_vars['preview_location']->value),"[time]",$_smarty_tpl->tpl_vars['preview_formated_time']->value);
} else {
echo smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace($_smarty_tpl->getConfigVariable('posted_by'),"[name]",$_smarty_tpl->tpl_vars['preview_name']->value),"[email_hp]",$_smarty_tpl->tpl_vars['email_hp']->value),"[time]",$_smarty_tpl->tpl_vars['preview_formated_time']->value);
}?></p>
<?php if ($_smarty_tpl->tpl_vars['preview_text']->value) {
echo $_smarty_tpl->tpl_vars['preview_text']->value;
} else { ?><p><?php echo $_smarty_tpl->getConfigVariable('no_text');?>
</p><?php }?>
...
echo $_smarty_tpl->getConfigVariable('email_notific_reply_thread');
} else {
echo $_smarty_tpl->getConfigVariable('email_notific_reply_post');
}?></label>
</p>
<?php }?>
...
<p>
<input id="terms_of_use_agree" type="checkbox" name="terms_of_use_agree" value="1"<?php if ($_smarty_tpl->tpl_vars['terms_of_use_agree']->value&&$_smarty_tpl->tpl_vars['terms_of_use_agree']->value==1) {?> checked="checked"<?php }?> />&nbsp;<label for="terms_of_use_agree"><?php if ($_smarty_tpl->tpl_vars['terms_of_use_url']->value) {
echo smarty_modifier_replace(smarty_modifier_replace($_smarty_tpl->getConfigVariable('terms_of_use_agreement'),"[[","<a id=\"terms_of_use\" href=\"".((string)$_smarty_tpl->tpl_vars['terms_of_use_url']->value)."\">"),"]]","</a>");
} else {
echo smarty_modifier_replace(smarty_modifier_replace($_smarty_tpl->getConfigVariable('terms_of_use_agreement'),"[[",''),"]]",'');
}?></label>
</p>
<?php }?>
</fieldset>
