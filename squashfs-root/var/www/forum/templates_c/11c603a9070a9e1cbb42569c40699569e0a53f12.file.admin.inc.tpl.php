<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-10-07 23:51:05
         compiled from "themes/default/subtemplates/admin.inc.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19653238595615afe92e8189-69019465%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '11c603a9070a9e1cbb42569c40699569e0a53f12' => 
    array (
  ...
  'nocache_hash' => '19653238595615afe92e8189-69019465',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5615afe9e28a53_56249753',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5615afe9e28a53_56249753')) {function content_5615afe9e28a53_56249753($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/var/www/forum/modules/smarty/plugins/modifier.replace.php';
if (!is_callable('smarty_function_cycle')) include '/var/www/forum/modules/smarty/plugins/function.cycle.php';
if (!is_callable('smarty_modifier_date_format')) include '/var/www/forum/modules/smarty/plugins/modifier.date_format.php';
...
<td><?php if ($_smarty_tpl->tpl_vars['categories_list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['row']['index']]['accession']==2) {
echo $_smarty_tpl->getConfigVariable('cat_accessible_admin_mod');
} elseif ($_smarty_tpl->tpl_vars['categories_list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['row']['index']]['accession']==1) {
echo $_smarty_tpl->getConfigVariable('cat_accessible_reg_users');
} else {
echo $_smarty_tpl->getConfigVariable('cat_accessible_all');
}?></td>
...
echo $_smarty_tpl->getConfigVariable('del_cat_keep_entries');?>

<?php } else {
echo $_smarty_tpl->getConfigVariable('del_cat_move_entries');?>
...
<td><span class="small"><?php if ($_smarty_tpl->tpl_vars['userdata']->value[$_smarty_tpl->getVariable('smarty')->value['section']['row']['index']]['user_type']==2) {
echo $_smarty_tpl->getConfigVariable('admin');
} elseif ($_smarty_tpl->tpl_vars['userdata']->value[$_smarty_tpl->getVariable('smarty')->value['section']['row']['index']]['user_type']==1) {
...
<td><span class="small"><?php if ($_smarty_tpl->tpl_vars['userdata']->value[$_smarty_tpl->getVariable('smarty')->value['section']['row']['index']]['logins']>0) {
echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['userdata']->value[$_smarty_tpl->getVariable('smarty')->value['section']['row']['index']]['last_login_time'],$_smarty_tpl->getConfigVariable('time_format'));
} else { ?>&nbsp;<?php }?></span></td>
<td><span class="small"><?php if ($_smarty_tpl->tpl_vars['userdata']->value[$_smarty_tpl->getVariable('smarty')->value['section']['row']['index']]['user_type']>0) {
if ($_smarty_tpl->tpl_vars['userdata']->value[$_smarty_tpl->getVariable('smarty')->value['section']['row']['index']]['user_lock']==0) {
echo $_smarty_tpl->getConfigVariable('unlocked');
} else {
echo $_smarty_tpl->getConfigVariable('locked');
}
} elseif ($_smarty_tpl->tpl_vars['userdata']->value[$_smarty_tpl->getVariable('smarty')->value['section']['row']['index']]['user_lock']==0) {?><a href="index.php?mode=admin&amp;user_lock=<?php echo $_smarty_tpl->tpl_vars['userdata']->value[$_smarty_tpl->getVariable('smarty')->value['section']['row']['index']]['user_id'];
if ($_smarty_tpl->tpl_vars['search_user_encoded']->value) {?>&amp;search_user=<?php echo $_smarty_tpl->tpl_vars['search_user_encoded']->value;
...
echo $_smarty_tpl->getConfigVariable('delete_users_confirmation');
} else {
echo $_smarty_tpl->getConfigVariable('delete_user_confirmation');
}?></p>
<ul>
<?php if (isset($_smarty_tpl->tpl_vars['smarty']->value['section']['nr'])) unset($_smarty_tpl->tpl_vars['smarty']->value['section']['nr']);
$_smarty_tpl->tpl_vars['smarty']->value['section']['nr']['name'] = 'nr';
...
if (!$_smarty_tpl->tpl_vars['graphical_captcha_available']->value||!$_smarty_tpl->tpl_vars['font_available']->value) {?><br /><?php echo $_smarty_tpl->getConfigVariable('captcha_graphical_desc');
}?></span></td>
<td class="d">
...
if (!$_smarty_tpl->tpl_vars['graphical_captcha_available']->value) {?> disabled="disabled"<?php }?> /><label for="captcha_posting_2"<?php if (!$_smarty_tpl->tpl_vars['graphical_captcha_available']->value) {?> class="unavailable"<?php }?>><?php echo $_smarty_tpl->getConfigVariable('captcha_graphical');
...
if (!$_smarty_tpl->tpl_vars['graphical_captcha_available']->value) {?> disabled="disabled"<?php }?> /><label for="captcha_email_2"<?php if (!$_smarty_tpl->tpl_vars['graphical_captcha_available']->value) {?> class="unavailable"<?php }?>><?php echo $_smarty_tpl->getConfigVariable('captcha_graphical');
if (!$_smarty_tpl->tpl_vars['graphical_captcha_available']->value||!$_smarty_tpl->tpl_vars['font_available']->value) {?><sup>*</sup><?php }?></label></td>
  </tr>
  <tr>
...
if (!$_smarty_tpl->tpl_vars['graphical_captcha_available']->value) {?> disabled="disabled"<?php }?> /><label for="captcha_register_2"<?php if (!$_smarty_tpl->tpl_vars['graphical_captcha_available']->value) {?> class="unavailable"<?php }?>><?php echo $_smarty_tpl->getConfigVariable('captcha_graphical');
if (!$_smarty_tpl->tpl_vars['graphical_captcha_available']->value||!$_smarty_tpl->tpl_vars['font_available']->value) {?><sup>*</sup><?php }?></label></td>
  </tr>
 </table>
...
echo $_smarty_tpl->getConfigVariable('gr_captcha_not_available');
} elseif (!$_smarty_tpl->tpl_vars['font_available']->value) {
echo $_smarty_tpl->getConfigVariable('gr_captcha_no_font');
}?></p>
 <?php }?>
</td>
</tr>
...
<?php if ($_smarty_tpl->tpl_vars['errors']->value) {
echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['theme']->value)."/subtemplates/errors.inc.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);
}?>
...
echo $_smarty_tpl->getConfigVariable('delete_backup_file_confirm');
} else {
echo $_smarty_tpl->getConfigVariable('delete_backup_files_confirm');
}?></p>
<ul>
<?php if (isset($_smarty_tpl->tpl_vars['smarty']->value['section']['nr'])) unset($_smarty_tpl->tpl_vars['smarty']->value['section']['nr']);
$_smarty_tpl->tpl_vars['smarty']->value['section']['nr']['name'] = 'nr';
...
echo $_smarty_tpl->getConfigVariable('folder_alt');
} else {
echo $_smarty_tpl->getConfigVariable('file_alt');
...
<?php if ($_smarty_tpl->tpl_vars['update_message']->value) {
...
<td><span class="small"><?php if ($_smarty_tpl->tpl_vars['pages']->value[$_smarty_tpl->getVariable('smarty')->value['section']['page']['index']]['menu_linkname']!='') {
echo $_smarty_tpl->tpl_vars['pages']->value[$_smarty_tpl->getVariable('smarty')->value['section']['page']['index']]['menu_linkname'];
} else { ?>&nbsp;<?php }?></span></td>
<td><span class="small"><?php if ($_smarty_tpl->tpl_vars['pages']->value[$_smarty_tpl->getVariable('smarty')->value['section']['page']['index']]['access']==1) {
echo $_smarty_tpl->getConfigVariable('page_access_reg_users');
} elseif ($_smarty_tpl->tpl_vars['pages']->value[$_smarty_tpl->getVariable('smarty')->value['section']['page']['index']]['access']==0) {
echo $_smarty_tpl->getConfigVariable('page_access_public');
}?></span></td>
