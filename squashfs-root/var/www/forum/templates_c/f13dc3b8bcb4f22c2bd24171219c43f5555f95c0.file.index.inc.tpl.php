...
<?php /*%%SmartyHeaderCode:8328022725615af9d2b2366-05264402%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f13dc3b8bcb4f22c2bd24171219c43f5555f95c0' => 
    array (
  ...
  'nocache_hash' => '8328022725615af9d2b2366-05264402',
  'function' => 
  array (
    'tree' => 
    array (
  ...
  'unifunc' => 'content_5615af9d487a24_00728476',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5615af9d487a24_00728476')) {function content_5615af9d487a24_00728476($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/var/www/forum/modules/smarty/plugins/modifier.replace.php';
...
echo smarty_modifier_replace($_smarty_tpl->getConfigVariable('posting_several_days_ago'),"[days]",$_smarty_tpl->tpl_vars['posting']->value['ago']['days_rounded']);
} else {
if ($_smarty_tpl->tpl_vars['posting']->value['ago']['days']==0&&$_smarty_tpl->tpl_vars['posting']->value['ago']['hours']==0) {
echo smarty_modifier_replace($_smarty_tpl->getConfigVariable('posting_minutes_ago'),"[minutes]",$_smarty_tpl->tpl_vars['posting']->value['ago']['minutes']);
} elseif ($_smarty_tpl->tpl_vars['posting']->value['ago']['days']==0&&$_smarty_tpl->tpl_vars['posting']->value['ago']['hours']!=0) {
echo smarty_modifier_replace(smarty_modifier_replace($_smarty_tpl->getConfigVariable('posting_hours_ago'),"[hours]",$_smarty_tpl->tpl_vars['posting']->value['ago']['hours']),"[minutes]",$_smarty_tpl->tpl_vars['posting']->value['ago']['minutes']);
} else {
echo smarty_modifier_replace(smarty_modifier_replace($_smarty_tpl->getConfigVariable('posting_one_day_ago'),"[hours]",$_smarty_tpl->tpl_vars['posting']->value['ago']['hours']),"[minutes]",$_smarty_tpl->tpl_vars['posting']->value['ago']['minutes']);
}
}?></a></li><?php } ?>
</ul>
</div>
...
<?php if (!is_callable('smarty_modifier_replace')) include '/var/www/forum/modules/smarty/plugins/modifier.replace.php';
...
if ($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['element']->value]['sticky']==1) {?>threadnew-sticky<?php } else { ?>threadnew<?php }
} elseif ($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['element']->value]['pid']==0) {
if ($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['element']->value]['sticky']==1) {?>thread-sticky<?php } else { ?>thread<?php }
...
echo $_smarty_tpl->getConfigVariable('one_reply');
} else {
echo smarty_modifier_replace($_smarty_tpl->getConfigVariable('several_replies'),"[replies]",$_smarty_tpl->tpl_vars['replies']->value[$_smarty_tpl->tpl_vars['thread']->value]);
...
} ?></ul><?php }?></li><?php $_smarty_tpl->tpl_vars = $saved_tpl_vars;
...
echo $_smarty_tpl->getConfigVariable('no_messages_in_category');
} else {
echo $_smarty_tpl->getConfigVariable('no_messages');
}?></p>
<?php }?>
